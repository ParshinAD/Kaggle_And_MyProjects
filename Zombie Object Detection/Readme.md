In this project I retrained RetinaNet to spot Zombies using just 5 training images. I setuped the model to restore pretrained weights and fine tune the classification layers.
